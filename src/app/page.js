...
export default function Home() {
  ...
  return (
    <Box sx={{ width: "100%" }} bgcolor={"#ffffff"}>
      ...
      <Box bgcolor={"#f3f6f4"}>
        <Box marginLeft={"2rem"} marginBottom={"1rem"} bgcolor={"#f3f6f4"}>
          <Typography>
      ...
      <Box bgcolor={"#f3f6f4"}>
        <ReadMore limit={27} bgcolor={"#f3f6f4"}>
          1231231231231231231231231231231112312312312312312312312312312312312312312312312312312312312311231231231231231231231231231231
        </ReadMore>
      </Box>
